        ...
        <div className="mx-4 flex h-8 justify-start px-4 pt-4 text-xl">
          {isSettingClickFocused ? (
            <>
              ...
              <button
                onClick={FavClick}
                className="ml-4 flex h-10 flex-row justify-between text-black hover:cursor-pointer"
              >
                <div className="flex flex-row text-2xl font-light">
            ...
            <>
              ...
              <button
                onClick={FavClick}
                className="ml-4 flex h-10 flex-row justify-between border-b-4 border-blue-main text-blue-main"
              >
                <div className="flex flex-row text-2xl font-light">
                  <BookmarkIcon className="m-1 mr-2 h-6 w-6" />
                  자주쓰는 말
