...
class FavoriteStarGlasses extends StatefulWidget {
  final Size size;
  final TextEditingController textController;
  FavoriteStarGlasses(
      {super.key, required this.size, required this.textController});

  @override
  State<FavoriteStarGlasses> createState() => _FavoriteStarState();
}

class _FavoriteStarState extends State<FavoriteStarGlasses> {
