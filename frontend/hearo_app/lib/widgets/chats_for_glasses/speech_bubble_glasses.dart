...
class SpeechBubbleGlasses extends StatefulWidget {
  final String message;
  final int who, textSize;
  final TextEditingController textController;
  final BluetoothCharacteristic characteristic;
  const SpeechBubbleGlasses({
    super.key,
  ...
  @override
  State<SpeechBubbleGlasses> createState() => _SpeechBubbleGlassesState();
}
...
class _SpeechBubbleGlassesState extends State<SpeechBubbleGlasses> {
