...
class BlueSearch2 extends StatefulWidget {
  const BlueSearch2({super.key});

  @override
  State<BlueSearch2> createState() => _Screen2State();
}

class _Screen2State extends State<BlueSearch2> {
