...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        Account createdUser = getUser(extractAttributes); // getUser() 메소드로 User 객체 생성 후 반환
     ...
     */
    private Account getUser(OAuthAttributes attributes) {
        Account findUser = accountRepository.findByEmail(attributes.getOauthUserInfo().getemail()).orElse(null);
     ...
     */
    private Account saveUser(OAuthAttributes attributes) {
        Account createdUser = attributes.toEntity(attributes.getOauthUserInfo());
